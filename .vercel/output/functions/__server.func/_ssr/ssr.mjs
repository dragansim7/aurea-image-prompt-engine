...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BQQdjujd.mjs");
...
var manifest = {
	"b7c56c215f1af8bd4ed0879d22e803276cb9843919d91f2f7534e58b54d3e3d3": {
		functionName: "analyzeImage_createServerFn_handler",
		importer: () => import("./analyze-DGryFZQe.mjs")
	},
	"f1f986b271d260c920985d4e870337bbc7d9a19967abcc96881afc56d730f622": {
		functionName: "visionStatus_createServerFn_handler",
		importer: () => import("./analyze-DGryFZQe.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-mkRiVlST.mjs").then((n) => n.t),
